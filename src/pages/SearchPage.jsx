    ...
    >
      ...
      <div className=" px-6 sm:px-10 lg:px-28 mx-auto py-8 sm:py-12">
        {isLoading ? (
          ...
          /* Empty State */
          <div>
            <div className="py-12 sm:py-20 flex flex-col items-center text-center max-w-xl mx-auto">
              <motion.div
                initial={{ scale: 0.8, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
                transition={{ type: "spring", stiffness: 200, damping: 15 }}
                className="w-20 h-20 rounded-full bg-rose-50 flex items-center justify-center text-[#E31E2E] mb-6"
              >
                <AlertCircle size={40} />
              </motion.div>
            ...
            {relatedBooks.length > 0 && (
              <div className="w-full text-left mt-8 border-t border-gray-200/60 pt-10 sm:pt-16">
